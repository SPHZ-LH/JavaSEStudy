...
public class test5 {
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < seatNumber; i++) {
            ...
            arr[tempPlace - 1].setId(id);// 直接赋值
            arr[tempPlace - 1].setPlace(place);// 直接赋值
        }
        ...
        for (int i = 0; i < findNumber; i++) {
            ...
            System.out.print(arr[tempPlace].getId());
            System.out.println(" ");
            System.out.println(arr[tempPlace].getPlace());
        }
        long end = System.currentTimeMillis();
        System.out.println("一段分式时间"+(end-frist));
    }
